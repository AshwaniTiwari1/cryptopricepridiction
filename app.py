...
import pandas as pd
from apps import home, model,lstm,linear,svm # import your app modules here

from PIL import Image 
image_directory = "logo.PNG"
image = Image.open(image_directory)

PAGE_CONFIG = {"page_title":"CRYPTO", 
               "page_icon":image, 
               "layout":"wide", 
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #3498DB;">
  <a class="navbar-brand" href="#" target="_blank">CRYPTO
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="template/team.html" target="_blank">Team</a>
      </li>
      <li class="nav-item">
...
st.markdown('''# **Cryptocurrency Today Price**
...
st.header('**All Cryptocurrency Performance **')
st.dataframe(df)
